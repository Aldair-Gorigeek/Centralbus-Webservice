...
public class CronConfigNotificaion {
    ...
    @Autowired
    private NotificacionProgramadaRunnable notificacionConfigurationService;
        
    private HashMap<String, String> cronMap = new HashMap<>();
    
    ScheduledFuture<?> vnotifySchedule = null;

    public CronConfigNotificaion() {
    ...
    public void run() {
        ...
        try{
            ...
            logger.error("Parametos de cron nulos ", e);
        } catch(Exception e){
